...
public class FlowLayoutFrame extends JFrame {
    ...
    public FlowLayoutFrame() {
        ...
        leftJButton.addActionListener(new ActionListener() { // classe interna anônima
        ...
        centerJButton.addActionListener(new ActionListener() { // classe interna anônima
        ...
        rightJButton.addActionListener(new ActionListener() { // classe interna anônima
